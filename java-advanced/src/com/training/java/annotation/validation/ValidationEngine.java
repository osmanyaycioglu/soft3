    ...
    public ValidateResult validate(final Object obj) {
        ...
        try {
            ...
            for (Field fieldLoc : declaredFieldsLoc) {
                Size validateStrLoc = fieldLoc.getAnnotation(Size.class);
                ...
                ListSize listValidateLoc = fieldLoc.getAnnotation(ListSize.class);
            ...
            resultLoc.addErrorDesc("Internal error " + eLoc.getMessage());
        }
        return resultLoc;
    }
}
